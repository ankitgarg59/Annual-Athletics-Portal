<?php
	   ...
	   $get_event = "select * from event_result WHERE event_name='800m Race'";
...
<div class="col-md-12 text-secondary">
	...
	<br><p><b style='text-align:center;font-size:18px;'>800 Metres Racing</b></p><hr></br>
	</div>
...
<div class="col-md-12 text-secondary">
		<div class="panel panel-default panel-info">
		   ...
		   <?php 
		      		...
		      		include("includes/db.php");
		      		$get_user = "select user_id from registered_participant where event_name='800m Race' and gender='Male'";
...
<div class="col-md-12 text-secondary">
		<div class="panel panel-default panel-info">
		   ...
		   <?php 
		      		...
		      		include("includes/db.php");
		      		$get_user = "select user_id from registered_participant where event_name='800m Race' and gender='Female'";
	         		$run_user = mysqli_query($connect,$get_user);
			 		$j=0;
			 		while($row_user = mysqli_fetch_array($run_user)){
				 	$j++;
